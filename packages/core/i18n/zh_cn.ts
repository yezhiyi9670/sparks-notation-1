...
export default {
	...
	issues: {
		...
		'lack_required': '此${0}中必须包含一个 ${1}(${2}) 或者同类指令，但是没有找到。',
		...
		"inspector": {
			...
			"determine_props": {
				...
				"speed": {
					"title": "拍速测定",
					"idle": "点击或将焦点移动到此处以开始",
					"preparing": "现在，通过继续点击此方框或按键盘上的空格、句点或 Enter 键打拍，尽可能保证打拍稳定。",
					"measuring": "已敲击 ${0} 次，共 ${1}s",
