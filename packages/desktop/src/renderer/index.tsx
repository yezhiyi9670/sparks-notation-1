...
import { IntegratedEditor, IntegratedEditorApi } from '@sparks-notation/react-editor/IntegratedEditor'
...
import { IntegratedEditorPrefs } from '@sparks-notation/react-editor/IntegratedEditor'
...
function App() {
	...
	return <I18nProvider languageKey={prefs.getValue<string>('language')}>
		<style>{`
			...
			.SparksNMN-sechl {
				background-color: ${ColorScheme.scoreHighlight} !important;
				opacity: 1 !important;
			}
			.SparksNMN-secsel {
